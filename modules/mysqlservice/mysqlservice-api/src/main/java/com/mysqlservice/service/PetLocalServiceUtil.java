 ...
 * <code>com.mysqlservice.service.impl.PetLocalServiceImpl</code> and
...
public class PetLocalServiceUtil {
	 ...
	 * @return the new pet
	 */
	public static Pet createPet(int pid) {
		return getService().createPet(pid);
	}
	 ...
	 */
	public static Pet deletePet(int pid) throws PortalException {
		return getService().deletePet(pid);
	}
	...
	public static Pet fetchPet(int pid) {
		return getService().fetchPet(pid);
	}
	 ...
	 * @throws PortalException if a pet with the primary key could not be found
	 */
	public static Pet getPet(int pid) throws PortalException {
		return getService().getPet(pid);
	}
	...
	public static List<Pet> getPetsByName(String pName) {
		return getService().getPetsByName(pName);
	}
